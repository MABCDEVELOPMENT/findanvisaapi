...
@Entity
@Table(name = "cosmetic_regularized_detail_holding_company")
public class CosmeticRegularizedDetailHoldingCompany  extends BaseEntity {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CosmeticRegularizedDetailHoldingCompany)) {
			return false;
		}
		CosmeticRegularizedDetailHoldingCompany other = (CosmeticRegularizedDetailHoldingCompany) obj;
		if (autorizacao == null) {
